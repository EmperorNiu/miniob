...
typedef struct {
  ...
  int isUnique;          // 0 非 unique； 1 unique index
  int attr_num;
...
void create_index_init(
    CreateIndex *create_index, const char *index_name, const char *relation_name,int isUnique);
void add_index_attr(
        CreateIndex *create_index, const char *attr_name);
